...
CHAT_ID=int(os.environ.get("-1001008888239", None))
TEXT=os.environ.get("Dear {name} 🎉 Welcome to Spidey Official!🎉 thrilled to have you here!", "Hello {mention}\nWelcome To {title}\n\nYour Auto Approved")
...
print("𝗕𝗼𝘁 𝗦𝘁𝗮𝗿𝘁𝗲𝗱 𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲 SPIDEYOFFICIAL")
pr0fess0r_99.run()
